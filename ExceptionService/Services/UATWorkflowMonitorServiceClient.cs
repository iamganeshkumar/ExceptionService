...
using WorkFlowMonitorUATServiceReference;

namespace ExceptionService.Services
{
    public class UATWorkflowMonitorServiceClient : IWorkflowMonitorServiceClient
    {
        private readonly WorkflowMonitorClient _client;

        public UATWorkflowMonitorServiceClient()
        {
